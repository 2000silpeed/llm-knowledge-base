...
- [ ] **P4-02** 파일 업로드 UI (드래그 앤 드롭)
  - 웹에서 직접 PDF/Word/Excel 파일 업로드 → 자동 인제스트
  - 업로드 진행률 표시, 완료 알림

- [ ] **P4-03** 동적 페이지 인제스트 ✅ 코드 완료, 미푸시
...
**마지막 업데이트:** 2026-04-09
**현재 단계:** Phase 5 설계 완료 — 구현 시작 전
**블로킹 이슈:** P4-03 푸시 대기 (gh 재인증 필요)
**다음 태스크:** P5-01 (개념 추출 단계) → P5-02 (개념별 컴파일) 순으로 진행
