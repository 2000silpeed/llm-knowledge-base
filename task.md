...
- [ ] **P2-01** 웹 UI — 마크다운 렌더링 + 검색 (Next.js + MDX)
- [ ] **P2-02** 개념 그래프 뷰 (D3.js)
- [ ] **P2-03** YouTube 자막 인제스터
- [ ] **P2-04** GitHub 레포 인제스터
- [ ] **P2-05** 위키 공유 기능 (읽기 전용 링크)
- [ ] **P2-06** 팀 지식베이스 (공유 raw/ + 개인 wiki/)
- [ ] **P2-07** 대용량 성능 최적화 (1000건+)
- [ ] **P2-08** API 비용 최적화 (응답 캐싱, 청크 전략)
...
**마지막 업데이트:** 2026-04-05
**현재 단계:** Phase 1 — 전체 완료 🎉, Phase 2 시작 가능
**블로킹 이슈:** 없음
**다음 태스크:** P2-01 (웹 UI) 또는 P2-03 (YouTube 자막 인제스터)
